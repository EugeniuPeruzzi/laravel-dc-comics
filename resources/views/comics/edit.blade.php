                        ...
                        <div class="row">
                            <div class="col-12 my-3">
                                ...
                                <input type="text" name="title" id="title" placeholder="Inserisci il titolo"
                                    class="form-control" value="{{ old('title') ?? $comic->title }}" required>
                            </div>
                            <div class="col-12 my-3">
                                <!-- Descrizione -->
                                ...
                                <textarea name="description" id="description" placeholder="Inserisci la descrizione" cols="30" rows="10"
                                    class="form-control" required>{{ old('description') ?? $comic->description }}</textarea>
                            </div>
                            <div class="col-12 my-3">
                                <!-- Thumb -->
                                <label class="control-label my-3">Thumb</label>
                                <input type="url" name="thumb" id="thumb" placeholder="Inserisci la thumb"
                                    class="form-control" value="{{ old('thumb') ?? $comic->thumb }}" required>
                            </div>
                            <div class="col-12 my-3">
                                <!-- Cover Image -->
                            ...
                            <div class="col-12 my-3">
                                ...
                                <input type="url" name="thumb2" id="thumb2" placeholder="Inserisci la thumb 2"
                                    class="form-control" value="{{ old('thumb2') ?? $comic->thumb2 }}" required>
                            </div>
                            <div class="col-12 my-3">
                                <!-- Prezzo -->
                            ...
                            <div class="col-12 my-3">
                                ...
                                <input type="text" name="series" id="series" placeholder="Inserisci la serie"
                                    class="form-control" value="{{ old('series') ?? $comic->series }}" required>
                            </div>
                            <div class="col-12 my-3">
                                <!-- Data di Rilascio -->
                                <label class="control-label my-3">Data di Rilascio</label>
                                <input type="date" name="sale_date" id="sale_date"
                                    placeholder="Inserisci la data di rilascio" class="form-control"
                            ...
                            <div class="col-12 my-3">
                                ...
                                <input type="text" name="type" id="type" placeholder="Inserisci il tipo"
                                    class="form-control" value="{{ old('type') ?? $comic->type }}" required>
                            </div>
                            <div class="col-12 my-3">
                                <!-- Artisti -->
                                ...
                                <textarea name="artists" id="artists" placeholder="Inserisci gli artisti" cols="30" rows="3"
                                    class="form-control" required>{{ old('artists') ?? $comic->artists }}</textarea>
                            </div>
                            <div class="col-12 my-3">
                                <!-- Scrittori -->
                                ...
                                <textarea name="writers" id="writers" placeholder="Inserisci gli scrittori" cols="30" rows="3"
                                    class="form-control" required>{{ old('writers') ?? $comic->writers }}</textarea>
                            </div>
